function [EI,l,n,dm,Diam,S,rho,CL0,CLa,CLd,Cm0,Cma,Cmd,xAE,xCG,xFins,Jy,xIMU,CD0,kD,Dref,Vx,gamma,acc,X0,Z0] = loadModel_EB(n)
...
%Fins
ARf = 1; Sfins = 2*0.15^2;
CLd = pi*ARf*Sfins/(1+sqrt(1+(pi*ARf/(2*0.7))^2))/S;
xFins = 2.5;
Cm0 = 0; 
CD0 = 0.95; kD = 1;
xAE = xCG-0.07; % Aerodynamic center
Dref = D_booster;
