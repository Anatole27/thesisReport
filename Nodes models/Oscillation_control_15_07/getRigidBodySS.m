function [Arb,Brb,Crb,Drb,alph0,T0,thetaT0,names] = getRigidBodySS(S,rho,CL0,CLa,CLd,xFins,Cm0,Cma,Cmd,xIMU,CD0,kD,Dref,V0,X0,Z0,gamm0,Vdot0,l,dm,listAcc)
...
m = sum(dm); % Mass
grav = 9.81;
[Jy,xCG] = inertia(dm,l); % Inertia and position of CG
