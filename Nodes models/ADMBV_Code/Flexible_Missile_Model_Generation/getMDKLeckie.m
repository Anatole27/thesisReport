function [M,D,K,Bo,Coz,Cov,Do] = getMDKLeckie(EI,l,n,dm,Diam)

%% Generates second-order structural model of a missile
%
...
%
% Inputs :
% * EI : bending stiffness vector along the beam [n-1] (N.m2)
% * l : length of an element of beam (m)
% * n : number of nodes
% * dm : mass vector [n] (kg)
% * Diam : diameter along the structure [n] (m)
%
% Outputs
% * M : mass matrix [n x n]
