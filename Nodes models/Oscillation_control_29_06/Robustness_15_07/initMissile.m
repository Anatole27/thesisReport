...
listAcc = [10 54 83 92];
[Arb,Brb,Crb,Drb,alph0,T0,thetaT0,names_rb] = getRigidBodySS(S,rho,CL0,CLa,CLd,xFins,Cm0,Cma,Cmd,xIMU,CD0,kD,Dref,Vx,X0,Z0,gamma,acc,l,dm,listAcc,Jy,xCG);
...
load_system('flexibleMissile');
load_system('missileSystem');
sys = ulinearize('flexibleMissile');
