function displaySim(Z0,X0,gamma,alph0,V0,xCG,thetaT0,thetaT,T0,z,x,theta,w,u,w_nodes,time,slowmo,n_nodes)
...
% Trajectory display
%windowTraj = figure;
traj = [x + V0*cos(gamma)*time, -z + V0*sin(gamma)*time];
%trajPlot = plot(traj(1,1),traj(1,2));
