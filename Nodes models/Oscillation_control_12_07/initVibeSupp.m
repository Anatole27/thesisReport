...
[EI,l,n,dm,Diam,S,rho,CL0,CLa,CLd,Cm0,Cma,xAE,xCG,xFins,Jy,xIMU,CD0,kD,Dref,Vx,gamma,acc,X0,Z0] = loadModel_EB(100);
m = sum(dm);
%% Rigid missile flight dynamics
listAcc = [10 54 83 92];
[Arb2,Brb2,Crb2,Drb2,alph0,T0,thetaT0,names_rb] = getRigidBodySS(S,rho,CL0,CLa,CLd,xFins,Cm0,Cma,xIMU,CD0,kD,Dref,Vx,X0,Z0,gamma,acc,l,dm,listAcc);
